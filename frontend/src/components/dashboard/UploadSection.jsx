...
const STAGES = {
  ...
  processing: { label: 'AI Segmentation running...', pct: 55 },
  ...
  return (
    <div className="flex flex-col space-y-5">
      ...
      <div
        ...
        style={{
          border: `2px dashed ${isDragOver ? '#6366f1' : file ? '#4f46e5' : '#334155'}`,
      ...
      >
        ...
        {file ? (
          <div className="flex flex-col items-center">
            ...
            <p className="text-white font-semibold text-lg max-w-xs truncate">{file.name}</p>
      ...
      {isUploading && (
        <div className="w-full space-y-2">
          ...
          <div className="flex justify-between text-xs text-slate-600 pt-1">
            {['Upload', 'Segment', 'Mesh', 'Complete'].map((s, i) => {
              const stepPct = [20, 55, 80, 100][i];
        ...
        <button
          ...
          style={{
            background: file
              ...
              : 'rgba(30,41,59,0.8)',
            boxShadow: file ? '0 4px 15px rgba(99,102,241,0.35)' : 'none',
            transition: 'all 0.2s',
            border: file ? 'none' : '1px solid rgba(71,85,105,0.4)',
          }}
